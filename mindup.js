    ...
    function PlayerTable(game, player, costs) {
        ...
        if (this.currentPlayer) {
            ...
            this.hand.onCardClick = function (card) {
                if (handDiv_1.classList.contains('bga-cards_selectable-stock')) {
...
var LOCAL_STORAGE_ZOOM_KEY = 'MindUp-zoom';
var MindUp = /** @class */ (function () {
    ...
    */
    ...
    //// Utility methods
    ///////////////////////////////////////////////////
    MindUp.prototype.setTooltip = function (id, html) {
        this.addTooltipHtml(id, html, this.TOOLTIP_DELAY);
    };
    MindUp.prototype.setTooltipToClass = function (className, html) {
    ...
    MindUp.prototype.getPlayerTable = function (playerId) {
        return this.playersTables.find(function (playerTable) { return playerTable.playerId === playerId; });
    };
    MindUp.prototype.getCurrentPlayerTable = function () {
        var _this = this;
    ...
    */
    MindUp.prototype.setupNotifications = function () {
...
define([
    ...
    return declare("bgagame.mindup", ebg.core.gamegui, new MindUp());
});
